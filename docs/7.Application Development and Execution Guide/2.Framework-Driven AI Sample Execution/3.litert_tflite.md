...
:::info **不想自己量化模型？**可以从 [Qualcomm AI Hub](https://aihub.qualcomm.com) 下载一系列的量化模型，或使用 [Edge Impulse](https://qc-ai-test.gitbook.io/qc-ai-test-docs/running-building-ai-models/edge-impulse) 来量化已有的或全新的模型。:::
...
### Vision Transformers  
以下是如何使用 LiteRT 委托在 CPU 和 NPU 上运行 Vision Transformer 模型（从 [AI Hub](https://aihub.qualcomm.com/models/vit) 下载)。
...
:::note• 	GTK 用于 GUI，OpenCV 用于图像处理，TensorFlow Lite 用于推理。:::
